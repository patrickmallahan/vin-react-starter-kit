...
var FuelSavingsCalculator = (function () {
    ...
    _createClass(FuelSavingsCalculator, null, [{
        ...
        value: function calculateSavings(config) {
            var monthlySavings = this.calculateSavingsPerMonth(config);
            var annualSavings = monthlySavings * 12;
            var threeYearSavings = annualSavings * 3;
            return {
                monthly: _numberFormatter2['default'].getCurrencyFormattedNumber(monthlySavings),
                annual: _numberFormatter2['default'].getCurrencyFormattedNumber(annualSavings),
                threeYear: _numberFormatter2['default'].getCurrencyFormattedNumber(threeYearSavings)
            };
        }
    }]);
...
},{"./mathHelper":158,"./numberFormatter":159}],158:[function(require,module,exports){
'use strict';
...
var NumberFormatter = (function () {
    ...
    _createClass(NumberFormatter, null, [{
        key: 'getCurrencyFormattedNumber',
        value: function getCurrencyFormattedNumber(value) {
            if (value === null) {
                return '';
            }
        ...
        value: function getFormattedNumber(value) {
            if (value === 0) {
                return 0;
            }
            ...
            var roundedValue = _mathHelper2['default'].roundNumber(value, 2); //round if more than 2 decimal points
        ...
        key: 'scrubFormatting',
        value: function scrubFormatting(value) {
...
},{"./mathHelper":158}],160:[function(require,module,exports){
'use strict';
...
var _businessLogicFuelSavingsCalculatorLogic = require('../businessLogic/FuelSavingsCalculatorLogic');

var _businessLogicFuelSavingsCalculatorLogic2 = _interopRequireDefault(_businessLogicFuelSavingsCalculatorLogic);
...
var FuelSavingsCalculator = (function (_React$Component) {
    ...
    _createClass(FuelSavingsCalculator, [{
        ...
        value: function updateState(event) {
            ...
            var necessaryDataIsEntered = this.necessaryDataIsEntered();
        ...
        value: function calculateSavings() {
            this.state.savings = _businessLogicFuelSavingsCalculatorLogic2['default'].calculateSavings(this.state);
...
},{"./components/FuelSavingsCalculator":160,"react":156}]},{},[162]);
